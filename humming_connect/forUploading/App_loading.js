    ...
    () => {
      ...
      const fetchDetails = async () => {
        try {
          ...
          .get('https://api.artsy.net/api/artists?gene_id=4d90d18fdcdd5f44a5000025&size=100&page=1&exact=true')
          ...
          .get('https://api.artsy.net/api/genes?size=100')
          .set('X-Xapp-Token', token)
          .set('Accept', 'application/vnd.artsy-v2+json')
          .then((res) => {
          ...
          .get('https://api.artsy.net/api/artworks?size=100&page=1&exact=true')
          .set('X-Xapp-Token', token)
          .set('Accept', 'application/vnd.artsy-v2+json')
          .then((res) => {
