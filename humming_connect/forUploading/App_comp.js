      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/" element={<Layout currentLoginStatus={{isLogin, setLoginStatus, id}}/>}>
            {/* <Route index element={<MainTest props={artList}/>}/> */}
            ...
            {/* <Route path="main" element={<MainTest props={artList}/>}/>  메인 */}           
            ...
            <Route path="mypage3/:loginId" element={<Mypage3/>}/> {/* 마이페이지3 */}
            <Route path="order/:id" element={<Order/>}/> {/* 주문 */}
            <Route path="payment/:id" element={<Payment/>}/> {/* 결제 페이지 */}
          ...
          <Route path="*/:id" element={<Error/>}/> {/* 에러페이지 */}
        </Routes>
      </BrowserRouter> 
      <GlobalStyle/>  
    </>    
